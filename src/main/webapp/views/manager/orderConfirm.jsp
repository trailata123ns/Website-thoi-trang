            ...
            <div id="layoutSidenav_content">
              <main>
                <div class="container-fluid">
                  ...
                  <h3 align="center">Danh sách đơn hàng chưa xác nhận</h3>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <c:if test="${order.status==false}">
                                  <a href="${base }/admin/confirmSaleOrder/${order.id}" class="btn btn-primary"
                                    onclick="onlickUpdate()">Xác nhận
                                  </a>
  
                                  <a href="${base }/admin/deleteSl/${order.id}" class="btn btn-danger">Hủy đơn hàng</a>
